class PhysiciansController < ApplicationController
  ...
  private
    ...
    def physician_params
      params.require(:physician).permit(:name, :specialty, offices_attributes: [:id, :street_address, :zip, :phone, :_destroy], appointments_attributes: [:id, :visit, :physician_id, :patient_id, :_destroy])
    end
end
